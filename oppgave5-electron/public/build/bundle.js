...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "klikk mig";
    			t5 = space();
    			button1 = element("button");
    			button1.textContent = "Online?";
    			t7 = space();
    			div = element("div");
    			attr_dev(h1, "class", "svelte-1uxgoth");
    			add_location(h1, file, 38, 1, 901);
    			add_location(p, file, 39, 1, 930);
    			add_location(button0, file, 40, 1, 945);
    			add_location(button1, file, 41, 1, 1044);
    			attr_dev(div, "class", "stuff svelte-1uxgoth");
    			add_location(div, file, 43, 1, 1102);
    			attr_dev(main, "class", "svelte-1uxgoth");
    			add_location(main, file, 37, 0, 893);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => showNotification("hei jørgen", "hvordan går det?");
